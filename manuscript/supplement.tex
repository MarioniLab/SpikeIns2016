...
To preserve the mean-variance relationship during downscaling, we fitted a loess curve of degree 1 to the original log-transformed NB dispersions against the log-mean of the fitted values across all cells.
