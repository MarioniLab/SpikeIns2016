...
Quality control was performed by removing libraries with outlier values for various metrics \citep{lun2016stepbystep}, including 
...
The first HVG detection method was based on the approach described by \cite{brennecke2013accounting}, with some modifications to the size factors in order to perform spike-in normalization.
