...
\begin{figure}[btp]
    \begin{center}
        \begin{subfigure}{0.24\textwidth}
            \includegraphics[width=\textwidth,page=2]{../simulations/pics/comparison_edgeR_DEG.pdf}
            \caption{}
        \end{subfigure}
        \begin{subfigure}{0.24\textwidth}
            \includegraphics[width=\textwidth,page=4]{../simulations/pics/comparison_edgeR_DEG.pdf}
            \caption{}
        \end{subfigure}
        \begin{subfigure}{0.24\textwidth}
            \includegraphics[width=\textwidth,page=2]{../simulations/pics/comparison_log_HVG.pdf}
            \caption{}
        \end{subfigure}
        \begin{subfigure}{0.24\textwidth}
            \includegraphics[width=\textwidth,page=4]{../simulations/pics/comparison_log_HVG.pdf}
            \caption{}
        \end{subfigure}
    \end{center}
    \caption{\revised{Properties of genes that were detected as DEGs or HVGs in the original data, and those that were no longer detected (lost) after simulating spike-in variability.
        (a, b) Absolute magnitudes of the log-fold changes of DEGs that were originally detected by edgeR or lost upon simulation in the 416B or mESC data sets.
    (c, d) Biological components of variation of HVGs that were originally detected by the variance of log-expression method or lost upon simulation in the 416B and TSC data sets.}
    }
\end{figure}
