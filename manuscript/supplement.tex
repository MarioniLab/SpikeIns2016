...
This adjusts the library size for each cell to reflect the differences in coverage of the spike-in transcripts.
Counts were then converted to count-per-million (CPM) values using the effective library sizes.
This ensures that the coverage of the spike-in transcripts is identical across libraries.
