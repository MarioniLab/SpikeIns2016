...
Specifically, the spike-in totals were rescaled to have a mean of unity across all libraries, and the size factor for each library was defined as its rescaled spike-in total (i.e., $T_{i1}$).
...
Size factors were defined from the spike-in totals as previously described. 
