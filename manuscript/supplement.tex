...
\subsection{Methods for differential expression}
For the mouse study, count data was obtained from the NCBI Gene Expression Omnibus under the accession GSE29087 \cite{islam2011characterization}.
...
Counts for the spiked-in synthetic transcripts were summed and used as the spike-in totals for each cell.
For the \textit{A. thaliana} study, count data was obtained as Supplementary Table~8 \cite{brennecke2013accounting}.
...
In both data sets, low-abundance cellular genes (i.e., those with an average count below 1) were removed.
