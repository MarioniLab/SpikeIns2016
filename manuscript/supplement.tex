...
We used this trend to determine the new NB dispersion for each transcript \revised{after downscaling.
...
\begin{figure}[btp]
    ...
    \caption{
        ...
        For each plate, a linear model was fitted to the log-ratios of the corresponding wells to account for \revised{factors in} the experimental design.
