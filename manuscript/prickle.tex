...
\newcommand{\suppfigspikeconc}{7}
\newcommand{\suppfigspikeave}{8}
...
The Supplementary Materials is a single PDF file that consists of Sections~1-\suppsecsim{} and contains Supplementary Figures~1-\suppfigspikeave{} and Supplementary Table~1.
