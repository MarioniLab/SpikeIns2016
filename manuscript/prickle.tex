...
\newcommand{\suppfigspikeconc}{6}
\newcommand{\suppfigspikeave}{7}
...
However, even at 40-50\% coverage, the variance due to sequencing noise (Supplementary Figure~\suppfignoise{}) is still an order of magnitude lower than the variance due to cell-specific biases (Figure~\ref{fig:varestimates}) or biological variability (Supplementary Figure~XXX).
