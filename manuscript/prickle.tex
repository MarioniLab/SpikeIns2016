...
The murine multipotent myeloid progenitor cell line 416B \cite{dexter1979isolation} was stably transduced with a TetOn construct of the \textit{Cbfb-MYH11} (CM) oncogene (type A cDNA), using an in-frame F2A-mCherry protein as a reporter. 
