...
Further details on these variables are provided in Section~BBB of the Supplementary Materials.
...
Implementation details of each method are provided in Section~Y in the Supplementary Materials. 
...
(See Section~Y in the Supplementary Materials for implementation details of each method.)
...
We thank Victoria Moignard and Wajid Jawaid for discussions about the experimental design.
We also thank Liliana Antunes for supplying the trophoblast cells.
...
The Supplementary Materials is a single PDF file that consists of Sections~1-2 and contains Supplementary Figures~1-4 and Supplementary Table~1.
